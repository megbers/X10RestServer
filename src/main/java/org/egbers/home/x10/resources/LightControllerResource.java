...
public class LightControllerResource {
	...
	public X10Response turnOn(@PathParam("house") String houseCode, @PathParam("unit") Integer unitCode) {
	...
	@Path("off/{house}/{unit}")
	@Produces(APPLICATION_JSON)
	public X10Response turnOff(@PathParam("house") String houseCode, @PathParam("unit") Integer unitCode) {
        X10Response response = new X10Response();
        try{
